<div align="center">  
  <h2><b> React To-Do List App </b></h2>
</div>
...
**React To-Do-App** is an interactive app created using React library where a user can create new To-Do's and add them to the list and display the list.
...
- **Can add a new to-do task input to the list**

- **Displays the list of tasks inputed by an user**
...
Project react-to-do-app is created with React.
...
```sh
  cd my-folder
  git clone git@github.com:tan12082001/react-to-do-app.git
```
